        ...
        <div class="container">
            <div class="row">
                ...
                <main class="col-md-9">
                    ...
                    <div class="form-inline">
                        <a class="mb-5" href="https://2gis.ru/moscow/geo/4504235282658633?m=37.634415%2C55.777286%2F17.21">Показать на карте</a>
                    </div>
                    <div class="form-inline">Часы работы Пн-Вс: 10:00 - 20:00</div>
                    <div class="form-inline">Телефон + 1 (234) 567-89-00</div>
                </main>
            </div>
        </div>
    </section>
