...
<section class="ftco-section testimony-section">
    ...
    <section class="site-review-form">
        <form enctype="multipart/form-data" method="post" id="feedback-form">
            ...
            <label for="messageFF">Ваш отзыв:</label>
            <textarea name="messageFF" id="messageFF" required rows="5" placeholder="Напишите своё мнение" class="w100 border"></textarea>
            <br>
            <div class="buttons_form">
                <input value="Отправить" type="submit" id="submitFF">
                <button class="btn-exit" id="close-button" style="border-radius: 10px">Закрыть</button>
            </div>
        </form>
    </section>
</section>
